...
sed -Ei "/mongo/{n;n;n;n;n;s/'login'.+?/'login' => '${MONGO_USERNAME}',/g}" /data/www/htdocs/tsb-server/app/config/database.php
sed -Ei "/mongo/{n;n;n;n;n;s/'password'.+?/'password' => '${MONGO_PASSWORD}',/g}" /data/www/htdocs/tsb-server/app/config/database.php
sed -Ei "/mongo/{n;n;n;n;n;s/'database'.+?/'database' => 'admin',/g}" /data/www/htdocs/tsb-server/app/config/database.php
